  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://hma-backend.onrender.com/api/v1/product/update-product/${id}`,
        productData,
        {
          headers: {
            Authorization: auth?.token,
  ...
  const handleDelete = async () => {
    try {
      ...
      const { data } = await axios.delete(
        `https://hma-backend.onrender.com/api/v1/product/delete-product/${id}`,
        {
          headers: {
            Authorization: auth?.token,
            //"Content-Type": "multipart/form-data",
            ...
            <form>
              ...
              <div>
                {photo ? (
                  ...
                  <div className="text-center">
                    <img
                      src={`https://hma-backend.onrender.com/api/v1/product/product-photo/${id}`}
                      alt="product_photo"
                      height={"200px"}
                      className="img h-[200px]"
                    />
